...
- `Services/Metadata`
  ...
  - verwaltet optional einen lokalen SQLite-Index aus den offiziellen IMDb-TSV-Datensätzen; Import und produktiver Austausch sind getrennt, damit ein Abbruch nie den letzten funktionierenden Index zerstört
- `Services/Emby`
